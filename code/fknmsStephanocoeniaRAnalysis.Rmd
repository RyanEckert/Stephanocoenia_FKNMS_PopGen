...
```{r, mafPlots}
mafPlots = (mafLrPlot| mafLrInbredPlot) +
  plot_annotation(tag_levels = 'A') &
  theme(plot.tag = element_text(size = 16))

ggsave("../figures/figure3.png", plot = mafPlots, width = 25, height = 8, units = "cm", dpi = 300)
ggsave("../figures/figure3.svg", plot = mafPlots, width = 25, height = 8, units = "cm", dpi = 300)
