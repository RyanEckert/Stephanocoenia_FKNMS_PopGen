...
#echo BA3SNP -v -u -s $RANDOM -i 5000000 -b 500000 -n 100 -m 0.2 -a 0.6 -f 0.025 -t -o fkSintBARun${i}Out.txt ../fkSintBayesAss.txt >> BayesAss$i.sh;
#mkdir run$i;
#mv BayesAss$i.sh run$i;
#cd run$i;
#sbatch -e BayesAss$i.e%j -o BayesAss$i.o%j -p longq7 --mail-user reckert2017@fau.edu --mail-type=ALL BayesAss$i.sh
#cd ..;
#done
